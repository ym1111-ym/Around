...
const (
	...
	BUCKET_NAME = "project2--bucket"
)

//add a hashmap, why is it not const?
//because hashmap doesn't support const form
var (
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//here use uuid to new a unique id
	id := uuid.New()
	//return a medialink and err
	...
	//p is the post, set the url
	p.Url = mediaLink

	//next step is annotate, first check if it is an image type
	if p.Type == "image" {

		//need to have a internal uri to do the annotate
	...
	//save to ES, id is the primary key, p is the post
...
// handler GET request sent to /cluster. Example request: http://localhost:8080/cluster?term=face
